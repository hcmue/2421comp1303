...
(32, 2, 'HC 2', 12022, 'ac', 'abc.jpg'),
(33, 1, 'Test hoa', 12345, '<ul><li><b>ANH</b> YEU</li></ul>', 'noname.png'),
(34, 1, 'Test hoa', 12345, '<ul><li><b>ANH</b> YEU</li></ul>', 'noname.png'),
(35, 1, 'Test hoa', 12345, '<ul><li><b>ANH</b> YEU</li></ul>', 'noname.png'),
(36, 1, 'Test hoa', 12345, '<ul><li><b>ANH</b> YEU</li></ul>', 'noname.png'),
(37, 1, 'Test hoa', 12345, '<ul><li><b>ANH</b> YEU</li></ul>', 'noname.png'),
(38, 2, 'Hoa cưới sinh xắn', 139000, '<p><b>Cưới có hoa</b></p>', 'NhaXBDHSPTpHCM.jpg');
...
--
ALTER TABLE `hoa`
  MODIFY `MaHoa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
